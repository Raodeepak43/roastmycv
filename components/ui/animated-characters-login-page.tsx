  ...
  return (
    <div className="shadcn-login-theme min-h-screen grid lg:grid-cols-2">
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-cn-primary/90 via-cn-primary to-cn-primary/80 p-12 text-cn-primary-foreground">
        ...
        <div className="relative z-20 flex items-center gap-8 text-sm text-cn-primary-foreground/60">
          <a href="/" className="hover:text-cn-primary-foreground transition-colors">
            Back to site
          </a>
        </div>

        <div className="absolute inset-0 bg-grid-white/[0.05] bg-[size:20px_20px]" />
        <div className="absolute top-1/4 right-1/4 size-64 bg-cn-primary-foreground/10 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 left-1/4 size-96 bg-cn-primary-foreground/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="flex items-center justify-center p-8 bg-cn-background">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-cn-muted-foreground text-sm">Enter your admin password to continue</p>
          </div>

          {configError && (
            <div className="mb-5 p-3 text-sm text-amber-700 bg-amber-50 border border-amber-200 rounded-lg">
              Set <code className="text-xs">ADMIN_PASSWORD</code> in your environment.
            </div>
          )}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pr-10 bg-cn-background border-cn-border/60 focus:border-cn-primary"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-cn-muted-foreground hover:text-cn-foreground transition-colors"
